...
def main():
    ...
    parser = argparse.ArgumentParser(description='Универсальная система резервного копирования БД')
    ...
    if args.scan_only:
        ...
        logging.info(f"Универсальная служба резервного копирования запущена")
